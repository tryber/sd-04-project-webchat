...
const moment = require('moment'); // biblioteca para formatar a hora, implementada com auxilio de Mirella.
...
io.on('connection', async (socket) => {
  ...
  socket.on('message', async (message) => {
    ...
    await chatModel.setNewMessage(message.chatMessage, message.nickname, timestamp);
